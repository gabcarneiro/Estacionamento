...
public class Tester {
    ...
    public static void main(String[] args) {
        ...
        Veiculo c3 = new Carro("ABK-1872", "Fusca", "Amanda" , "098.715.249-19");
        Veiculo c4 = new Carro("NWD-3576", "Fusa", "Tania", "408.367.537-17");
        Veiculo c5 = new Carro("RBG-2311", "Fusca", "Noeli", "682.829.319-34");
